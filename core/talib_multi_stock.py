...
# Essa classe foi criada apenas para teste. E DEVERÁ ser otimizada para ser escalável!!!
...
class TaLib():
    ...
    def lista_de_indicadores(self):
        ...
        frame = {'DATE_{}'.format(df_num): date, 'TIME_{}'.format(df_num): time,
                 'OPEN_{}'.format(df_num):oopen, 'HIGH_{}'.format(df_num):high,
                 'LOW_{}'.format(df_num):low, 'CLOSE_{}'.format(df_num):close,
